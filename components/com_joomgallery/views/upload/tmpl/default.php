...
<?php endif;
  ...
  <div class="jg_uploadquotas">
    ...
    <?php echo JText::sprintf('COM_JOOMGALLERY_UPLOAD_NEW_IMAGE_MAXSIZE', number_format($this->_config->get('jg_maxfilesize')/* / 1024*/, 0, JText::_('COM_JOOMGALLERY_COMMON_DECIMAL_SEPARATOR'), JText::_('COM_JOOMGALLERY_COMMON_THOUSANDS_SEPARATOR'))); ?><br />
