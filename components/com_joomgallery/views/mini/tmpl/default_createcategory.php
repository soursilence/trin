<?php defined('_JEXEC') or die('Restricted access'); ?>
  <div class="jg-slider jg_uploadform">
    <form action="<?php echo JRoute::_('index.php?task=category.save&tmpl=component&redirect='.base64_encode('index.php?view=mini&tmpl=component')); ?>" method="post" name="CreateCategoryForm" onsubmit="return joom_categoryCheck()">
      <div class="jg_uprow">
      ...
      <div class="jg_uprow">
        <div class="jg_uptext">
          <input type="submit" value="<?php echo JText::_('COM_JOOMGALLERY_COMMON_SAVE'); ?>" class="button" />
        </div>
      </div>
