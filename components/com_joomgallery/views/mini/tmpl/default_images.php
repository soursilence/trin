...
<?php endif; ?>
  ...
  <div class="joomgallery-slider">
    <div class="jg_bu_search">
      <form action="<?php echo JRoute::_('index.php?view=mini&tmpl=component&e_name='.$this->e_name.'&object='.JRequest::getVar('object')); ?>" name="adminForm" method="post" onsubmit="javascript:ajaxRequest('<?php echo 'index.php?option='._JOOM_OPTION.'&view=mini&format=json'; ?>', 1, 'search=' + this.search.value); return false;">
