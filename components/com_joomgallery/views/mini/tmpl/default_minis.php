...
<?php endif;
      if(!$row->thumb_src): ?>
      <div class="jg_bu_no_mini" title="<?php echo JText::_('COM_JOOMGALLERY_MINI_NO_THUMB'); ?>::<?php echo JText::sprintf('COM_JOOMGALLERY_MINI_NO_THUMB_TIP', $row->id, $row->imgtitle); ?>" class="hasMiniTip">
