...
// $Id: thumbnail.php 3789 2012-05-20 08:52:49Z erftralle $
/****************************************************************************************\
**   JoomGallery  2                                                                     **
  ...
  protected function getInput()
  {
    ...
    function joom_selectimage(id, title, object, filename) {
      ...
      if(id != '') {
        ...
        document.getElementById('".$imagelib_id."').src = '".JURI::root(true)."/media/system/images/blank.png';
      }
    ...
    $html = '
    <a class="modal-button" title="'.JText::_('COM_JOOMGALLERY_COMMON_SELECT_THUMBNAIL_TIP').'" href="'.$link.'" rel="{handler: \'iframe\', size: {x: 750, y: 480}}">'.JText::_('COM_JOOMGALLERY_COMMON_SELECT').'</a>
